...
_C.TRAIN.RANDOM_TRANSLATION_PROB = 1.0
...
_C.MODEL.DISTILLATION_WEIGHT = 10.0
...
_C.MODEL.DISTILLATION_SAMPLES = 2
_C.MODEL.MULTI_ONLY = True
...
# -----------------------------------------------------------------------------
_C.SOLVER = Node() 
_C.SOLVER.BASE_LR = 0.00008 # 0.01
