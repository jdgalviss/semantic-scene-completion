...
_C.TRAIN.CHECKPOINT_PERIOD = 25
_C.TRAIN.EVAL_PERIOD = 5
# _C.TRAIN.STEPS = [5, 15, 31]
_C.TRAIN.STEPS = [25, 70, 75]

# DATA AUGMENTATION
_C.TRAIN.AUGMENT = True
_C.TRAIN.NOISE_LEVEL = 0.1
# _C.TRAIN.FLIP_AUGMENT = True # unused
# Rotation
_C.TRAIN.ROT_AUG_Z = [-15., 15.]
_C.TRAIN.ROT_AUG_Y = [0., 2.5]
_C.TRAIN.ROT_AUG_X = [-1., 1.]
_C.TRAIN.RANDOM_TRANSLATION = False

# _C.TRAIN.DROPOUT = 0.35 #unused
...
# -----------------------------------------------------------------------------
_C.MODEL = Node() 
_C.MODEL.OCCUPANCY_64_WEIGHT = 10.0
_C.MODEL.SEMANTIC_64_WEIGHT = 20.0  
_C.MODEL.OCCUPANCY_128_WEIGHT = 20
_C.MODEL.SEMANTIC_128_WEIGHT = 40.0   
_C.MODEL.OCCUPANCY_256_WEIGHT = 40.0
_C.MODEL.SEMANTIC_256_WEIGHT = 80.0   
...
_C.SOLVER.DECAY_STEP = 100
_C.SOLVER.LR_DECAY = 0.7
_C.SOLVER.LR_CLIP = 1e-6
