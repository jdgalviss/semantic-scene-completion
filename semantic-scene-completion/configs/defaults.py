...
_C.TRAIN.EVAL_PERIOD = 500
_C.TRAIN.STEPS = [501, 1501]
...
_C.MODEL.SEMANTIC_256_WEIGHT = 0.5   
_C.MODEL.NUM_OUTPUT_CHANNELS = 8
_C.MODEL.UNET_FEATURES = 8
