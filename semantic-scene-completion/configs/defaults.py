...
_C.TRAIN.ROT_AUG_Y = [0.,0.5]
_C.TRAIN.ROT_AUG_X = [0.0, 0.0]
...
_C.MODEL.SEMANTIC_64_WEIGHT = 0.2  
...
# -----------------------------------------------------------------------------
_C.SOLVER = Node() 
_C.SOLVER.BASE_LR = 0.001 # next multiply by 10
