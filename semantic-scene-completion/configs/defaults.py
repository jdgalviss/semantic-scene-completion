...
_C.GENERAL.NUM_SAMPLES_OVERFIT = 2
_C.GENERAL.LEVEL = "64"
...
_C.TRAIN.STEPS = [15, 30, 35]
# _C.TRAIN.STEPS = [25, 50, 60]
...
_C.TRAIN.DROPOUT = 0.1 # probability of element being zeroed
...
# -----------------------------------------------------------------------------
_C.MODEL = Node() 
_C.MODEL.OCCUPANCY_64_WEIGHT = 5.0
...
_C.MODEL.OCCUPANCY_128_WEIGHT = 10.0
_C.MODEL.SEMANTIC_128_WEIGHT = 60.0   
_C.MODEL.OCCUPANCY_256_WEIGHT = 20.0
